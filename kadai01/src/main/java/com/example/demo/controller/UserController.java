...
public class UserController {
	...
	public String create(@Validated @ModelAttribute UserRequest userRequest, BindingResult result, Model model) {
		...
		if (result.hasErrors()) {
			model.addAttribute("validationError",
					result.getAllErrors().stream().map(error -> error.getDefaultMessage()).toList());
			return "user/add";
		}
	...
	public String update(@Validated @ModelAttribute UserUpdateRequest uur, BindingResult result, Model model) {
