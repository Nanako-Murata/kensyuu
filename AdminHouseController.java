...
public class AdminHouseController {
	...
	public String update(@ModelAttribute @Validated HouseEditFrom houseEditForm, BingdingReuslt bindingResult, RedirectAttributes redirectAttributes) {
		if (bindingResult.has.Errors()) {
			return "admin/house/edit";
		}
		houseService.update(houseEditForm);
		redirectAttributes.addFlashAttribute("successMessage", "民博情報を編集しました");
		return "redirect:/admin/houses";
	}
	@PostMapping("/{id}/delete")
	public String delete(@PathVariable(name="id") Integer id, RedirectAttributes redirectAttributes) {
		houseRepository.deleteById(id);
		redirectAttribute.addFlashAttriubte("successMessage", "民博を削除しました");
		return "redirect:/admin/houses";
	}
}